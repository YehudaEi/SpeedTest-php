...
async function startTest(){
  if(status == "" || status == "stop"){
    status = "start";
    _paq.push(["trackEvent","user","startBetaSpeedTest"]);
    ...
    status = "stop";
    _paq.push(["trackEvent","user","stopBetaSpeedTest"]);
  ...
  status = "";
  _paq.push(["trackEvent","user","doneBetaSpeedTest"]);
  setText("status", "done.");
